 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.tibco.com/schemas/TIBCO/Maiden_Hotels_Project/Schemas/Clients.xsd}Guest" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class Client {
    ...
    protected List<Guest> guestClient;
    ...
    public Client(List<Guest> guestClient, String id, String idGuest, String moneySpent, String password) {
    ...
    public List<Guest> getGuest() {
        if (guestClient == null) {
            guestClient = new ArrayList<Guest>();
        }
